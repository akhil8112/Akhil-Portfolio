      ...
      <div className="what-box">
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                ...
                Designing responsive UIs, robust APIs, and scalable architectures.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                ...
                Building dashboards, reports, and data pipelines to drive decisions.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
          ...
          >
            ...
            <div className="what-content-in">
              <h3>DEVOPS</h3>
              <h4>Streamlining Development & Deployment</h4>
              <p>
                Automating CI/CD pipelines, managing cloud infrastructure,
                and ensuring reliable, scalable deployments.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
